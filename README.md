...
AZDone est une couche d'entrée, `/azd`, posée sur **18 Agent Skills
...
- L'état du projet et de la confiance reste dans le dépôt utilisateur
  (`.azdone/`).
- Les 18 dossiers de skills passent les contrôles structurels et la suite de
  contrats locale.
...
[référence des 18 skills](docs/reference-skills.md).

## Documentation

- [Le guide AZDone](docs/guide/README.md)
- [Positionnement et non-objectifs](docs/POSITIONNEMENT.md)
- [Glossaire des concepts](docs/glossaire.md)
