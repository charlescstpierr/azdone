...
2. `$construire-solution-azd` écrit le plus petit correctif que la preuve justifie, avec un test rouge avant le correctif quand c'est peu coûteux.
3. `$prouver-resultat-azd` rejoue la reproduction d'origine. Elle doit passer.
