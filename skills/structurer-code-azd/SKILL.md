...
description: "Décider la structure du code avant d'écrire une ligne: formes de données, frontières, invariants et options comparées. Utiliser lorsqu'un changement traverse une frontière de module, ajoute de l'état ou une forme de donnée, touche plus de trois fichiers, ou laisse le choix entre plusieurs structures."
---
...
- un changement traverse une frontière de module, ajoute de l'état ou une forme de donnée, touche plus de trois fichiers, ou laisse le choix entre plusieurs structures;
...
8. Découper la structure retenue en unités vérifiables ordonnées, chacune avec sa preuve, et les rendre à `$planifier-travail-azd`.
...
- Aucune abstraction sans complexité réelle démontrée: supprimer avant d'ajouter reste la règle par défaut.
